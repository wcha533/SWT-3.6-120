...
REAL(4), PARAMETER           :: PC_RefSpd     =     162.0014612                 ! Desired (reference) HSS speed for pitch controller, rad/s.
...
REAL(4), PARAMETER           :: VS_CtInSp     =      62.3082543                 ! Transitional generator speed (HSS side) between regions 1 and 1 1/2, rad/s.
...
REAL(4), PARAMETER           :: VS_MaxTq      =   2743459.479                   ! Maximum generator torque in Region 3 (HSS side), N-m. -- chosen to be 10% above VS_RtTq = 43.09355kNm
REAL(4), PARAMETER           :: VS_Rgn2K      =       0.6       ! 0.73391082    ! Generator torque constant in Region 2 (HSS side), N-m/(rad/s)^2.
REAL(4), PARAMETER           :: VS_Rgn2Sp     =      81.00073059                ! Transitional generator speed (HSS side) between regions 1 1/2 and 2, rad/s.
...
REAL(4), PARAMETER           :: VS_RtGnSp     =     160.3814466                 ! Rated generator speed (HSS side), rad/s. -- chosen to be 99% of PC_RefSpd
REAL(4), PARAMETER           :: VS_RtPwr      = 4000000                     ! Rated generator generator power in Region 3, Watts. -- chosen to be 5MW divided by the electrical generator efficiency of 94.4%
...
IF ( ( iStatus >= 0 ) .AND. ( aviFAIL >= 0 ) )  THEN  ! Only compute control calculations if no error has occured and we are not on the last time step
   ...
   avrSWAP(48) = 0.3 ! Demanded nacelle yaw rate
